...
load("3_data_analysis/monkey_metabolomics_data_cleaning/RPLC/POS/object_pos2")
object_pos2

load("3_data_analysis/monkey_metabolomics_metabolite_annotation/hmdb_ms2.rda")
load("3_data_analysis/monkey_metabolomics_metabolite_annotation/massbank_ms2.rda")
load("3_data_analysis/monkey_metabolomics_metabolite_annotation/metlin_ms2.rda")
load("3_data_analysis/monkey_metabolomics_metabolite_annotation/mona_ms2.rda")
load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/mpsnyder_hilic_ms2.rda"
)
load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/mpsnyder_rplc_ms2.rda"
)
load("3_data_analysis/monkey_metabolomics_metabolite_annotation/nist_ms2.rda")
...
setwd("3_data_analysis/monkey_metabolomics_metabolite_annotation/RPLC/POS/")
...
setwd(r4projects::get_project_wd())
load("3_data_analysis/monkey_metabolomics_data_cleaning/RPLC/NEG/object_neg2")
object_neg2

setwd("3_data_analysis/monkey_metabolomics_metabolite_annotation/RPLC/NEG/")
...
setwd(r4projects::get_project_wd())
load("3_data_analysis/monkey_metabolomics_data_cleaning/HILIC/POS/object_pos2")
setwd("3_data_analysis/monkey_metabolomics_metabolite_annotation/HILIC/POS/")
...
setwd(r4projects::get_project_wd())
load("3_data_analysis/monkey_metabolomics_data_cleaning/HILIC/NEG/object_neg2")
object_neg2

setwd("3_data_analysis/monkey_metabolomics_metabolite_annotation/HILIC/NEG/")
