...
load("3-data_analysis/monkey_fMSEA_analysis_rplc/5_redundant_removal/annotation_table")
load("3-data_analysis/monkey_fMSEA_analysis_rplc/1_data_preparation/RPLC/POS/object_rplc_pos")
load("3-data_analysis/monkey_fMSEA_analysis_rplc/1_data_preparation/RPLC/NEG/object_rplc_neg")

dir.create("3-data_analysis/monkey_fMSEA_analysis_rplc/6_pmd_analysis")
setwd("3-data_analysis/monkey_fMSEA_analysis_rplc/6_pmd_analysis")
