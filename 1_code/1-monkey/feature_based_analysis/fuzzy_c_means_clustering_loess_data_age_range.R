...
setwd(r4projects::get_project_wd())
dir.create("3-data_analysis/monkey_feature_analysis/fuzzy_clustering_loess_data/age_range")
setwd("3-data_analysis/monkey_feature_analysis/fuzzy_clustering_loess_data/age_range")
