...
load("3_data_analysis/monkey_metabolomics_data_preparation/object_hilic_pos")
load("3_data_analysis/monkey_metabolomics_data_preparation/object_hilic_neg")
load("3_data_analysis/monkey_metabolomics_data_preparation/object_rplc_pos")
load("3_data_analysis/monkey_metabolomics_data_preparation/object_rplc_neg")

###data quality assessment
load("3_data_analysis/monkey_metabolomics_data_preparation/metabolite/object")

setwd("3_data_analysis/monkey_metabolomics_data_overview")
...
plot <-
  temp_data %>% 
  dplyr::select(column, row, injection.order, class) %>%
