...
load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/RPLC/POS/object_rplc_pos"
)

load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/RPLC/NEG/object_rplc_neg"
)

load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/HILIC/POS/object_hilic_pos"
)

load(
  "3_data_analysis/monkey_metabolomics_metabolite_annotation/HILIC/NEG/object_hilic_neg"
)
...
setwd("3_data_analysis/monkey_metabolomics_data_preparation/")
